...
shinyServer(function(input, output,session) {#----
 ...
 # GIS <- reactive(input$WMU_Shp)
  ...
  fun.getModDescr <- function(model_description) {
    ...
    fun.fixDest <- function(ddf.1.D) {
     ...
     # print(paste("MIKE CHECK Made it past first as.data.frame DEBUG-in fun.fixDest"))
      table$Estimate <- as.numeric(table$Estimate) * 1000
      table$se<-as.numeric(table$se)*1000
      table$lcl<-as.numeric(table$lcl)*1000
      table$ucl<-as.numeric(table$ucl)*1000
  ...
  OL <- eventReactive(list(input$MegaDB$datapath, input$truncation), { ####----
    ...
    DistanceInput<- cbind.data.frame(object.ID = as.numeric(DistancePreInput.MOOS$ID), Region.Label= DistancePreInput.MOOS$Stratum,Area = as.numeric(DistancePreInput.MOOS$Stratum.Area), TID = as.numeric(DistancePreInput.MOOS$Transect.ID), TLENGTH = as.numeric(DistancePreInput.MOOS$Transect.Length), Effort=as.numeric(DistancePreInput.MOOS$Transect.Length)/1000, distance= as.numeric(DistancePreInput.MOOS$DistancePerp), size=as.numeric(DistancePreInput.MOOS$MOOS.GroupSize),CC=as.factor(DistancePreInput.MOOS$Covariate.1), Activity=as.factor(DistancePreInput.MOOS$Covariate.2))
    ...
    DistanceInput.MD<- cbind.data.frame(object.ID = as.numeric(DistancePreInput.MUDE$ID), Region.Label= DistancePreInput.MUDE$Stratum,Area = as.numeric(DistancePreInput.MUDE$Stratum.Area), TID = as.numeric(DistancePreInput.MUDE$Transect.ID), TLENGTH = as.numeric(DistancePreInput.MUDE$Transect.Length), Effort=as.numeric(DistancePreInput.MUDE$Transect.Length)/1000, distance= as.numeric(DistancePreInput.MUDE$DistancePerp), size=as.numeric(DistancePreInput.MUDE$MUDE.GroupSize),CC=as.factor(DistancePreInput.MUDE$Covariate.1), Activity=as.factor(DistancePreInput.MUDE$Covariate.2))
    DistanceInput.MD <- DistanceInput.MD[ order(DistanceInput.MD$Region.Label, DistanceInput.MD$TID, DistanceInput.MD$size), ]

    DistanceInput2 <- cbind.data.frame(object = as.numeric(DistancePreInput.MOOS$ID), 
                                       Region.Label= DistancePreInput.MOOS$Stratum,
                                       Area = as.numeric(DistancePreInput.MOOS$Stratum.Area), 
                                       Sample.Label = as.numeric(DistancePreInput.MOOS$Transect.ID), 
                                       Effort = as.numeric(DistancePreInput.MOOS$Transect.Length), 
                                       distance= as.numeric(DistancePreInput.MOOS$DistancePerp), 
                                       size=as.numeric(DistancePreInput.MOOS$MOOS.GroupSize),
                                       CC=as.factor(DistancePreInput.MOOS$Covariate.1), 
                                       Activity=as.factor(DistancePreInput.MOOS$Covariate.2))
    DistanceInput2 <- unique(DistanceInput2)
    DistanceInput2.MD <- cbind.data.frame(object = as.numeric(DistancePreInput.MUDE$ID), Region.Label= DistancePreInput.MUDE$Stratum,Area = as.numeric(DistancePreInput.MUDE$Stratum.Area), Sample.Label = as.numeric(DistancePreInput.MUDE$Transect.ID), Effort = as.numeric(DistancePreInput.MUDE$Transect.Length), distance= as.numeric(DistancePreInput.MUDE$DistancePerp), size=as.numeric(DistancePreInput.MUDE$MUDE.GroupSize),CC=as.factor(DistancePreInput.MUDE$Covariate.1), Activity=as.factor(DistancePreInput.MUDE$Covariate.2))
    ...
    DistanceInput.WT<- cbind.data.frame(object.ID = as.numeric(DistancePreInput.WTDE$ID), 
                                        Region.Label= DistancePreInput.WTDE$Stratum,
                                        Area = as.numeric(DistancePreInput.WTDE$Stratum.Area), 
                                        TID = as.numeric(DistancePreInput.WTDE$Transect.ID),
                                        TLENGTH = as.numeric(DistancePreInput.WTDE$Transect.Length),
                                        Effort=as.numeric(DistancePreInput.WTDE$Transect.Length)/1000, 
                                        distance= as.numeric(DistancePreInput.WTDE$DistancePerp),
                                        size=as.numeric(DistancePreInput.WTDE$WTDE.GroupSize),
                                        CC=as.factor(DistancePreInput.WTDE$Covariate.1), 
                                        Activity=as.factor(DistancePreInput.WTDE$Covariate.2))
    DistanceInput.WT <- DistanceInput.MD[ order(DistanceInput.WT$Region.Label, DistanceInput.WT$TID, DistanceInput.WT$size), ]
    DistanceInput2.WT <- cbind.data.frame(object = as.numeric(DistancePreInput.WTDE$ID), 
                                          Region.Label= DistancePreInput.WTDE$Stratum,
                                          Area = as.numeric(DistancePreInput.WTDE$Stratum.Area), 
                                          Sample.Label = as.numeric(DistancePreInput.WTDE$Transect.ID), 
                                          Effort = as.numeric(DistancePreInput.WTDE$Transect.Length), 
                                          distance= as.numeric(DistancePreInput.WTDE$DistancePerp), 
                                          size=as.numeric(DistancePreInput.WTDE$WTDE.GroupSize),
                                          CC=as.factor(DistancePreInput.WTDE$Covariate.1), 
                                          Activity=as.factor(DistancePreInput.WTDE$Covariate.2))
    ...
    DistanceInput.WAPT<- cbind.data.frame(object.ID = as.numeric(DistancePreInput.WAPT$ID), Region.Label= DistancePreInput.WAPT$Stratum,Area = as.numeric(DistancePreInput.WAPT$Stratum.Area), TID = as.numeric(DistancePreInput.WAPT$Transect.ID), TLENGTH = as.numeric(DistancePreInput.WAPT$Transect.Length), Effort=as.numeric(DistancePreInput.WAPT$Transect.Length)/1000, distance= as.numeric(DistancePreInput.WAPT$DistancePerp), size=as.numeric(DistancePreInput.WAPT$WAPT.GroupSize),CC=as.factor(DistancePreInput.WAPT$Covariate.1), Activity=as.factor(DistancePreInput.WAPT$Covariate.2))
    ...
    DistanceInput.HORS<- cbind.data.frame(object.ID = as.numeric(DistancePreInput.HORS$ID), Region.Label= DistancePreInput.HORS$Stratum,Area = as.numeric(DistancePreInput.HORS$Stratum.Area), TID = as.numeric(DistancePreInput.HORS$Transect.ID), TLENGTH = as.numeric(DistancePreInput.HORS$Transect.Length), Effort=as.numeric(DistancePreInput.HORS$Transect.Length)/1000, distance= as.numeric(DistancePreInput.HORS$DistancePerp), size=as.numeric(DistancePreInput.HORS$HORS.GroupSize),CC=as.factor(DistancePreInput.HORS$Covariate.1), Activity=as.factor(DistancePreInput.HORS$Covariate.2))
  ...
  #  moos.hn_cos_3 <- ds(DistanceInput2, truncation = truncvalue(), key="hn", adjustment = "cos", order = 3)
   ...
   # mlist <- list(moos.hn_cos, moos.hr_cos, moos.hr_poly, moos.unif_cos,  moos.hn_cos_2,  moos.hn_cos_3, moos.hn_herm,  moos.hr_herm)
    ...
    model_result_df <- do.call("rbind.data.frame", model_results)
  ...
  OL.MD   <- eventReactive(OL(), {
    ...
    model_result_df.MUDE <- do.call("rbind.data.frame", model_results.md)
 ...
 #   ddf.1.mude<-ds(OL()$DistanceInput2.MD, truncation = truncvalue(), key="hn", adjustment = "cos")
  ...
  OL.WAPT <- eventReactive(OL(), {
    ...
    model_result_df.WAPT <- do.call("rbind.data.frame", model_results.wapt)
  ...
  OL.MAP <- eventReactive(input$WMU_Shp, {
    ...
    from.coords <- cbind.data.frame(TID =trans.flown$UniqueID,X =trans.flown$FROM_X, "y"=trans.flown$FROM_Y)
    #  to.coords <- cbind.data.frame(TID =trans.flown$UniqueID,X =trans.flown$TO_X, "y"=trans.flown$TO_Y))
    f <- cbind.data.frame(X =trans.flown$FROM_X, "y"=trans.flown$FROM_Y)
    t <- cbind.data.frame(X =trans.flown$TO_X, "y"=trans.flown$TO_Y)
 ...
 #      plot(p)
  ...
  output$MUDE_MAP <- renderPlot({
    ...
    DistancePreInput.MUDE <- unique(DistancePreInput.MUDE)
    DistanceInput<- cbind.data.frame(object.ID = as.numeric(DistancePreInput.MUDE$ID), Region.Label= DistancePreInput.MUDE$Stratum,Area = as.numeric(DistancePreInput.MUDE$Stratum.Area), TID = as.numeric(DistancePreInput.MUDE$Transect.ID), TLENGTH = as.numeric(DistancePreInput.MUDE$Transect.Length), Effort=as.numeric(DistancePreInput.MUDE$Transect.Length)/1000, distance= as.numeric(DistancePreInput.MUDE$DistancePerp), size=as.numeric(DistancePreInput.MUDE$MUDE.GroupSize),CC=as.factor(DistancePreInput.MUDE$Covariate.1), Activity=as.factor(DistancePreInput.MUDE$Covariate.2))
    DistanceInput <- DistanceInput[ order(DistanceInput$Region.Label, DistanceInput$TID, DistanceInput$size), ]
    trans.flown <- sqlFetch(myconn, "transects_flown")
    trans.all <- sqlFetch(myconn, "transects")
    close(myconn)
  ...
  output$WTDE_MAP <- renderPlot({
   ...
   #!!!!!!!!!!!!# results_num_index <- OL()$results_num_index
    ...
    DistanceInput<- cbind.data.frame(object.ID = as.numeric(DistancePreInput.WTDE$ID), Region.Label= DistancePreInput.WTDE$Stratum,Area = as.numeric(DistancePreInput.WTDE$Stratum.Area), TID = as.numeric(DistancePreInput.WTDE$Transect.ID), TLENGTH = as.numeric(DistancePreInput.WTDE$Transect.Length), Effort=as.numeric(DistancePreInput.WTDE$Transect.Length)/1000, distance= as.numeric(DistancePreInput.WTDE$DistancePerp), size=as.numeric(DistancePreInput.WTDE$WTDE.GroupSize),CC=as.factor(DistancePreInput.WTDE$Covariate.1), Activity=as.factor(DistancePreInput.WTDE$Covariate.2))
  ...
  output$WAPT_MAP <- renderPlot({
   ...
   #!!!!!!# results_num_index <- OL()$results_num_index
    ...
    DistanceInput<- cbind.data.frame(object.ID = as.numeric(DistancePreInput.WAPT$ID), Region.Label= DistancePreInput.WAPT$Stratum,Area = as.numeric(DistancePreInput.WAPT$Stratum.Area), TID = as.numeric(DistancePreInput.WAPT$Transect.ID), TLENGTH = as.numeric(DistancePreInput.WAPT$Transect.Length), Effort=as.numeric(DistancePreInput.WAPT$Transect.Length)/1000, distance= as.numeric(DistancePreInput.WAPT$DistancePerp), size=as.numeric(DistancePreInput.WAPT$WAPT.GroupSize),CC=as.factor(DistancePreInput.WAPT$Covariate.1), Activity=as.factor(DistancePreInput.WAPT$Covariate.2))
  ...
  output$HORS_MAP <- renderPlot({
   ...
   #!!!!!!!!!!# results_num_index <- OL()$results_num_index
    ...
    DistanceInput<- cbind.data.frame(object.ID = as.numeric(DistancePreInput.HORS$ID), Region.Label= DistancePreInput.HORS$Stratum,Area = as.numeric(DistancePreInput.HORS$Stratum.Area), TID = as.numeric(DistancePreInput.HORS$Transect.ID), TLENGTH = as.numeric(DistancePreInput.HORS$Transect.Length), Effort=as.numeric(DistancePreInput.HORS$Transect.Length)/1000, distance= as.numeric(DistancePreInput.HORS$DistancePerp), size=as.numeric(DistancePreInput.HORS$HORS.GroupSize),CC=as.factor(DistancePreInput.HORS$Covariate.1), Activity=as.factor(DistancePreInput.HORS$Covariate.2))
